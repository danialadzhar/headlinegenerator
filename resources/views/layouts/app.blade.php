    ...
    <div id="app">
        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-9">
                    <h4>
                        <a href="#" class="text-decoration-none text-dark">{{ config('app.name') }}</a> 
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="btn btn-danger float-end hide-logout-mobile" style="border-radius: 20px;">Sign Out<i class="bi bi-box-arrow-right"></i></button>
                        </form>
                    </h4>
                </div>
                <div class="col-md-3">
